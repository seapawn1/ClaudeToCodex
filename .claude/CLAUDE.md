...
Sprint 03 was split on 2026-09-14 after Planning resumed against `main` / `v1.2.0` (`15309b2`). Current Sprint 03 focuses on PBI-09 readable arrival and automatic continuation; active record: `scrum/sprint-03-readable-arrival/SprintBacklog.md`. PBI-10+13 and PBI-12 are reserved in `scrum/sprint-06-connection-control/SprintBacklog.md` and `scrum/sprint-07-target-identification/SprintBacklog.md` as pending Planning seeds, not current commitments. The PO participates in key experience choices, research needs and Ideate opportunities. Product implementation has not started; after Planning closes, Developers lead execution and adapt their plan, the SM follows the Goal and impediments and independently checks AC evidence, and the PO participates in value decisions and end-to-end acceptance.
