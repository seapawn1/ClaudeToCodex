...
<small><em>Q1 中的接收时机是 PO 已确认的需求，尚未完成符合该标准的双端实测；消息进入上下文后，接收方自行判断是否调整当前工作。Q2 至 Q5 仍需实际协作验证，其中 Q5 是价值假设。后续选择 Target 时据此确定验证重点。</em></small>
...
<small><em>检视位置：双方获知消息对应 Q1；提供背景与理解问题对应 Q2；回应和追问对应 Q3；判断处理及接续工作对应 Q4；PO 的实际参与负担对应 Q5。该图供选择 Target 前共同检视。</em></small>
